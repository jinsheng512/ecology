 ...
 *
 */
public class SetQiBeiWorkflowStatus  implements Action {
	
	private static BaseBean baseBean=new BaseBean();

   private static Log log = LogFactory.getLog(SetQiBeiWorkflowStatus.class.getName());
...
//		
		...
		JsonObject isok =HttpRequestUtil.postJson("http://haikongbl.haikongjinrong.com:8888/api/fin/loan/pcsign", params, true);

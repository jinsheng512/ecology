...
public class EASLoginProxyServiceLocator extends org.apache.axis.client.Service implements greedc.ws.client.eas.EASLoginProxyService {
    ...
    public greedc.ws.client.eas.EASLoginProxy getEASLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            greedc.ws.client.eas.EASLoginSoapBindingStub _stub = new greedc.ws.client.eas.EASLoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (greedc.ws.client.eas.EASLoginProxy.class.isAssignableFrom(serviceEndpointInterface)) {
                greedc.ws.client.eas.EASLoginSoapBindingStub _stub = new greedc.ws.client.eas.EASLoginSoapBindingStub(new java.net.URL(EASLogin_address), this);
                _stub.setPortName(getEASLoginWSDDServiceName());
                return _stub;
            }
        }

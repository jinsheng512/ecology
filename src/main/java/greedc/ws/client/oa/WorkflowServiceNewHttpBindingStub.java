/**
 * WorkflowServiceNewHttpBindingStub.java
 *
...
public class WorkflowServiceNewHttpBindingStub extends org.apache.axis.client.Stub implements greedc.ws.client.oa.WorkflowServiceNewPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("webservices.services.weaver.com.cn", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://oa.server.webservice.ecustom", "CustomWorkflowRequestInfo"), greedc.ws.client.oa.CustomWorkflowRequestInfo.class, false, false);
    ...
    public WorkflowServiceNewHttpBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public WorkflowServiceNewHttpBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public WorkflowServiceNewHttpBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://oa.server.webservice.ecustom", "CustomWorkflowRequestInfo");
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.CustomWorkflowRequestInfo.class;
            ...
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.ArrayOfWorkflowDetailTableInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.ArrayOfWorkflowRequestLog.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.ArrayOfWorkflowRequestTableField.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.ArrayOfWorkflowRequestTableRecord.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.WorkflowBaseInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.WorkflowDetailTableInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.WorkflowMainTableInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.WorkflowRequestLog.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.WorkflowRequestTableField.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.WorkflowRequestTableRecord.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.ArrayOfArrayOfString.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.oa.ArrayOfString.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public java.lang.String doCreateWorkflowRequest(greedc.ws.client.oa.CustomWorkflowRequestInfo in0, int in1) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPActionURI("urn:ecustom.webservice.server.oa.IWorkflowService.doCreateWorkflowRequest");
        _call.setEncodingStyle(null);

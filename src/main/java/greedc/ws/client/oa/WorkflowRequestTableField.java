...
public class WorkflowRequestTableField  implements java.io.Serializable {
    ...
    private greedc.ws.client.oa.ArrayOfString selectnames;
    private greedc.ws.client.oa.ArrayOfString selectvalues;
    ...
    public WorkflowRequestTableField(
           ...
           greedc.ws.client.oa.ArrayOfString selectnames,
           greedc.ws.client.oa.ArrayOfString selectvalues,
     ...
     * @return selectnames
     */
    public greedc.ws.client.oa.ArrayOfString getSelectnames() {
        return selectnames;
    }
     ...
     * @param selectnames
     */
    public void setSelectnames(greedc.ws.client.oa.ArrayOfString selectnames) {
        this.selectnames = selectnames;
    }
     ...
     * @return selectvalues
     */
    public greedc.ws.client.oa.ArrayOfString getSelectvalues() {
        return selectvalues;
    }
     ...
     * @param selectvalues
     */
    public void setSelectvalues(greedc.ws.client.oa.ArrayOfString selectvalues) {
        this.selectvalues = selectvalues;
    }

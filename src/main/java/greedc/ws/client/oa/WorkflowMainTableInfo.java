...
public class WorkflowMainTableInfo  implements java.io.Serializable {
    private greedc.ws.client.oa.ArrayOfWorkflowRequestTableRecord requestRecords;
    ...
    public WorkflowMainTableInfo(
           greedc.ws.client.oa.ArrayOfWorkflowRequestTableRecord requestRecords,
     ...
     */
    public greedc.ws.client.oa.ArrayOfWorkflowRequestTableRecord getRequestRecords() {
        return requestRecords;
    }
     ...
     */
    public void setRequestRecords(greedc.ws.client.oa.ArrayOfWorkflowRequestTableRecord requestRecords) {
        this.requestRecords = requestRecords;
    }

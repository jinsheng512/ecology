...
/**
 * 生成“合同到期续签申请”接口Action。
 * @author William
 */
public class GreedcFlow127Action implements ICustomWorkflowServiceAction {
	
	private String dbFieldName = "BIAODBH";
	private String dhFieldValue = null;
	private String tableName = "FORMTABLE_MAIN_35";
	...
	public void doBefore(CustomWorkflowRequestInfo request) {
		...
		String workCode = GreedcUtil.getFieldValue(dtField, "yifxmCode");
		// 将工作转换成ID

 ...
 * @author William
 */
public class GreedcFlow244Action implements ICustomWorkflowServiceAction {
	
	private HrmResource creator = null;
	private String dhFieldName = null;
	private String tableName = "FORMTABLE_MAIN_57";
	...
	public void doAfter(String requestId) {
		...
		try {
			...
			String sql = "UPDATE FORMTABLE_MAIN_57 SET GONGH=? WHERE REQUESTID=?";

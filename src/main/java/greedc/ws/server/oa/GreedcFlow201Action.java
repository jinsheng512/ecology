...
/**
 * 生成“项目奖励申请流程”流程Action。
 * @author William
 */
public class GreedcFlow201Action implements ICustomWorkflowServiceAction {
	
	private HrmResource creator = null;
	private String dhFieldName = null;
	private String tableName = "FORMTABLE_MAIN_49";
	...
	public void doAfter(String requestId) {
		...
		String sql = "UPDATE FORMTABLE_MAIN_49 SET GONGH=? WHERE REQUESTID=?";

 ...
 * @author William
 */
public class GreedcFlow181Action implements ICustomWorkflowServiceAction {
	
	private HrmResource creator = null;
	private String dhFieldName = null;
	private String tableName = "FORMTABLE_MAIN_48";
	...
	public void doAfter(String requestId) {
		...
		String sql = "UPDATE " + this.tableName + " SET GONGH=? WHERE REQUESTID=?";

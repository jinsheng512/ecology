 ...
 * @author William
 */
public class GreedcFlow241Action implements ICustomWorkflowServiceAction {
	
	private HrmResource creator = null;
	private String dhFieldName = null;
	private String tableName = "FORMTABLE_MAIN_55";
	...
	public void doAfter(String requestId) {
		...
		String sql = "UPDATE FORMTABLE_MAIN_55 SET GONGH=? WHERE REQUESTID=?";

 ...
 *
 */
public class FnaEas12Action implements Action{
	...
	public String execute(RequestInfo request) {
		...
		try {
			bb.writeLog("FnaEas12Action:"+request.getRequestid());
			...
			String tableAmount = Util.null2String(bb.getPropValue("QC228542", "table_"+formIdInt+"_amount"));//主表字段,合计金额小写
			...
			String sql1 = "select a."+tableNumber+" as tableNumber,"
							  ...
							  + " a.kaihyhskwb as tableCollectionCompanyKHH, "
...
//							  + " a."+tableCollectionCompanyKHH+" as tableCollectionCompanyKHH, "
			...
			if(!sqlFlag){
				throw new Exception("sql出错，位置FnaEas12Action-001");
			}
			String tableNumber_val = "";
			double tableAmount_val = 0d;
			int tableCompany_val = 0;
			String tableCollectionCompany_val = "";
...
//			if(!sqlFlag){
//				throw new Exception("sql出错，位置FnaEas12Action-002");
//			}
//			String yhmc = "";
//			while(rs.next()){

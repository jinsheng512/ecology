/**
 * QiBeiServiceHttpBindingStub.java
 *
...
public class QiBeiServiceHttpBindingStub extends org.apache.axis.client.Stub implements greedc.ws.client.qb.QiBeiServicePortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param.setNillable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("webservices.services.weaver.com.cn", "in5"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://qibei.server.webservice.ecustom", "ArrayOfDetailBean"), greedc.ws.client.qb.DetailBean[].class, false, false);
        param.setItemQName(new javax.xml.namespace.QName("http://qibei.server.webservice.ecustom", "DetailBean"));
        param.setNillable(true);
        oper.addParameter(param);
    ...
    public QiBeiServiceHttpBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public QiBeiServiceHttpBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public QiBeiServiceHttpBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://qibei.server.webservice.ecustom", "ArrayOfDetailBean");
            cachedSerQNames.add(qName);
            cls = greedc.ws.client.qb.DetailBean[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://qibei.server.webservice.ecustom", "DetailBean");
            qName2 = new javax.xml.namespace.QName("http://qibei.server.webservice.ecustom", "DetailBean");
    ...
    public java.lang.String getQiBeiData(java.lang.String in0, java.lang.String in1, java.lang.String in2, java.lang.String in3, java.lang.String in4, greedc.ws.client.qb.DetailBean[] in5) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("webservices.services.weaver.com.cn", "getQiBeiData"));

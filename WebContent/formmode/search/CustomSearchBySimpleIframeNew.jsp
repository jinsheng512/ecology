...
if(rs.getDBType().equals("oracle")){
	sql = "select a.id,b.listbatchname expendname,a.expenddesc,b.isuse,a.issystem,a.issystemflag,a.defaultenable,a.hreftarget,a.hreftype,a.hrefid,a.opentype,b.listbatchname from mode_pageexpand a left join mode_batchset b on a.id = b.expandid and b.customsearchid = "+customid+" where a.isbatch in(1,2) "+isVirtualFormFilterSql+" and a.modeid = " + modeid + " and nvl(b.isshortcutbutton,0)=1 and a.isshow=1 order by b.showorder asc";
}else{
	sql = "select a.id,b.listbatchname expendname,a.expenddesc,b.isuse,a.issystem,a.issystemflag,a.defaultenable,a.hreftarget,a.hreftype,a.hrefid,a.opentype,b.listbatchname from mode_pageexpand a left join mode_batchset b on a.id = b.expandid and b.customsearchid = "+customid+" where a.isbatch in(1,2) "+isVirtualFormFilterSql+" and a.modeid = " + modeid + " and isnull(b.isshortcutbutton,0)=1 and a.isshow=1 order by b.showorder asc";	
}
...
function Add(){
	...
	String customParam = "";
	if ("2".equals(customid)) {
		String pid = request.getParameter("pid");
		if (pid == null || "root".equals(pid)) {
			pid = "";
		}
		customParam = "&field6120=" + pid;
	}
	%>
	var url = "/formmode/view/AddFormMode.jsp?customTreeDataId=<%=customTreeDataId%>&mainid=<%=mainid%>&modeId=<%=modeid%>&formId=<%=formID%>&type=1<%=createurl+treeFieldStr%><%=customParam %>";
	window.open(url);
}

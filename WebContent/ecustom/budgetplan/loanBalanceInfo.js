...
//	var endDate = $('#endDate').val();
	...
	$('#btnExport').bind('click', function(){
		 ...
		 $("#dg").datagrid('toExcel',"余额明细计表.xls");
//		
	});
...
//        onLoadSuccess: compute,//加载完毕后执行计算
		mode: 'remote',
		url: '/greedc/servlets/Loan-dataGridBalance.json',
		queryParams: {
			name: 'CV_LOADBALANCEINFO',
			key: 'id',
			sort: 'id desc',
			startDate: startDate,
			field: 'id,subcompanyname,benwb,yuanb,yewrq,lastname,bankmc,jinrjg,kaihh,yinhzh,zhanghxzmc,currencydesc,shifjgzh,shifdkjajhzyh,yongt',
			defFilter: '',

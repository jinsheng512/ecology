...
<script type="text/javascript" src="companyFundsPlan.js"></script>
<style type="text/css">
* {
	font-size: 12px;
}
...
<body>
	...
	<input type="hidden" id="yearMonth" name="yearMonth" value="<%=request.getParameter("yearMonth") %>"/>
	...
	<div id="fundsdiv" align="center">
		<table id="tbFunds" cellpadding="0" cellspacing="0" style="width:80%">
			<tr>
				<th colspan="12" style="font-size: 18px; padding-top: 10px; padding-bottom: 10px;">格力地产资金计划明细表</th>
			</tr>
			<tr>
				<th>公司</th>
				<th id="companyName" colspan="7" style="text-align: left;"></th>
				<th>日期</th>
				<th id="yearAndMonth" colspan="2"></th>
				<th>单位：万元</th>
			</tr>
			<tr>
				<th>序号</th>
			...
			<tr>
	            ...
	            <td class="right cashBeginHap" id="cashBeginHap">&nbsp;</td>
				<td class="right cashBeginDam" id="cashBeginDam">&nbsp;</td>
				<td class="right cashBeginDra" id="cashBeginDra">&nbsp;</td>
				<td class="right cashBeginNpl" id="cashBeginNpl">&nbsp;</td>

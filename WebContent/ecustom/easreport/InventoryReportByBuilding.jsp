...
<head>
	...
	<script type="text/javascript" src="InventoryReportByBuilding.js?time=20170928"></script>
</head>
<body>
...
<table cellspacing="0" cellpadding="0" style="border: 0px; width: 100%;">
	<tr>
		<td style="line-height: 27px;height: 28px; border: 0px; min-width: 1px; width: 360px;">
			<div class="tabUnSelect" onclick="window.location.href='InventoryReportByRoomModel.jsp'">格力地产库存报表（户型）</div>
			<div class="tabSelect">格力地产库存报表（楼栋）</div>
		</td>
